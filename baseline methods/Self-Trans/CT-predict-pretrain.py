...
parser.add_argument('--train-root', default='../../Images-processed', type=string,
                    help='root directory for training dataset')

parser.add_argument('--val-root', default='../../Images-processed', type=string,
                    help='root directory for validation dataset')

parser.add_argument('--test-root', default='../../Images-processed', type=string,
                    help='root directory for testing dataset')

parser.add_argument('--data-split', default='../../Data-split', type=string,
